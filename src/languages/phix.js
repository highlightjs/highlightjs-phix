/*
Language: Phix
Author: Pete Lomax <petelomax@ymail.com>
Description: Phix is a hybrid interpreted/compiled general purpose programming language.
Category: common, scripting, web, assembler
Website: http://phix.x10.mx
*/

module.exports = function (hljs) {
//  const SHEBANG = hljs.COMMENT('^#!', '$');
//DEV inline things...
    const BLOCKSHEBANG = hljs.COMMENT('#[', ']#');
    const LINE_COMMENT = hljs.COMMENT('--', '$');
    const BLOCK_COMMENT = hljs.COMMENT('/\\*','\\*/',{contains:['self']});
    const LONG_BLOCK_COMMENT = hljs.COMMENT('--/\\*','--\\*/',{contains:['self']});
    const COMMENTS = [
//          SHEBANG,
            hljs.SHEBANG,
            BLOCKSHEBANG,
    ...
    const TRIPLEQUOTE_STRINGS = {
//          scope: 'string',
            begin: '"""',
            end: '"""',
    };
    const BACKTICK_STRINGS = {
//          scope: 'string',
            begin: '`',
            end: '`',
//        {
...
//        }
    ...
    // Note: these lists were auto-generated by pwa/p2js.exw for pygments, then edited.
    const TYPES = [
    ...
    const KWDS = [
        ...
        'private', 'public', 'static', 'struct', 'trace', 'format', 
    ...
    const BUILT_INS = [
        ...
        'float80_to_atom', 'get_bytes', 'get_file_date',
